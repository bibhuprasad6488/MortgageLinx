    ...
    <div class="row">
        <div class="col-md-6 mx-auto">
            <form action="{{ route('admin.service-categories.update', $category->id) }}" method="POST"
                enctype="multipart/form-data" id="catUploadForm">
                @csrf
                @method('PUT')
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row  mb-2">
                            ...
                            <div class="col-md-8 col-sm-6 col-xs-12">
                                <textarea name="short_desc" id="short_desc" class="form-control " rows="3">{{ $category->short_desc }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row  mb-2">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="drop-area" data-input="cat_image" data-preview="catImgPreview"
                                    data-default="{{ $category->cat_image ?? asset('admin/img/no-img.png') }}">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <img src="" id="catImgPreview" width="150">
                            </div>
                        </div>
                        <div class="form-group row  mb-2">
                            <label for="Img" class="col-md-3 d-flex justify-content-end col-sm-3 col-xs-12">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="drop-area" data-input="footer_icon" data-preview="catFooterIconPreview"
                                    data-default="{{ $category->footer_icon ?? asset('admin/img/no-img.png') }}">
                                    <p>Drag & Drop Image Here or Click to Select</p>
                        ...
                        <div class="form-group row  mb-2">
                            ...
                            <div class="col-md-8 col-sm-6 col-xs-12">
                                <input type="checkbox" name="show_on_home" id="show_on_home"
                                    @if ($category->show_on_home) checked @endif class="" value="1">
                            </div>
                        </div>
                        ...
                        <div class="form-group row  mb-2">
                            ...
                            <div class="col-md-8 col-sm-6 col-xs-12">
                                <textarea name="meta_desc" id="meta_desc" class="form-control " rows="3">{{ $category->meta_desc }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row  mb-2">
                            <label for="" class="col-md-3 d-flex justify-content-end col-sm-3 col-xs-12">Meta
