...
@section('content')
    ...
    <div id="mortgage" class="carousel slide" data-bs-ride="carousel"
        style="background-image: url('{{ asset('images/mortgate_banner.jpg') }}')">
                ...
                @foreach ($services as $s)
                    <div class="col br1 ">
                        <div class="text-center mortgage_col">
                            <p class="icon"><img src="{{ $s->thumb_image ?? asset('images/icon24.png') }}"></p>
        ...
        <div class="container">
            <div class="row">
                <div class="row row-cols-1 row-cols-sm-2">
                    <div class="col">
                        <img src="{{ asset('images/mortgage.png') }}" class="w-100 coverage">
                    </div>
                    <div class="col">
